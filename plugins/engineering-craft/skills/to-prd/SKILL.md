---
name: to-prd
description: Turn the current conversation context into a PRD for an initiative-scale effort and publish it to the GitHub Project. Use ONLY for a large, multi-issue initiative — for discrete work (a single feature or bug) file an issue directly or use to-issues instead.
---
